...
%  %%%  Get the ensemble mean of the posterior at each time step
...
tm=datetime(2020,3,30)+days(247:360);
...
%%%%SIMULATED R0
%%%cabo delgabo
r01=xpost(59,:,247:360).*xpost(58,:,247:360).*(xpost(70,:,247:360)+(1-xpost(70,:,247:360)).*xpost(56,:,247:360));
um=shiftdim(r01,1);
r01_mean=squeeze(mean(um));

%%%gaza
r02=xpost(60,:,247:360).*xpost(58,:,247:360).*(xpost(71,:,247:360)+(1-xpost(71,:,247:360)).*xpost(56,:,247:360));
um=shiftdim(r02,1);
r02_mean=squeeze(mean(um));

%%%inhambane
r03=xpost(61,:,247:360).*xpost(58,:,247:360).*(xpost(72,:,247:360)+(1-xpost(72,:,247:360)).*xpost(56,:,247:360));
um=shiftdim(r03,1);
r03_mean=squeeze(mean(um));

%%%manica
r04=xpost(62,:,247:360).*xpost(58,:,247:360).*(xpost(73,:,247:360)+(1-xpost(73,:,247:360)).*xpost(56,:,247:360));
um=shiftdim(r04,1);
r04_mean=squeeze(mean(um));

%%%maputo cidade
r05=xpost(63,:,247:360).*xpost(58,:,247:360).*(xpost(74,:,247:360)+(1-xpost(74,:,247:360)).*xpost(56,:,247:360));
um=shiftdim(r05,1);
r05_mean=squeeze(mean(um));

%%%maputo provincia
r06=xpost(64,:,247:360).*xpost(58,:,247:360).*(xpost(75,:,247:360)+(1-xpost(75,:,247:360)).*xpost(56,:,247:360));
um=shiftdim(r06,1);
r06_mean=squeeze(mean(um));

%%%nampula
r07=xpost(65,:,247:360).*xpost(58,:,247:360).*(xpost(76,:,247:360)+(1-xpost(76,:,247:360)).*xpost(56,:,247:360));
um=shiftdim(r07,1);
r07_mean=squeeze(mean(um));

%%%niassa
r08=xpost(66,:,247:360).*xpost(58,:,247:360).*(xpost(77,:,247:360)+(1-xpost(77,:,247:360)).*xpost(56,:,247:360));
um=shiftdim(r08,1);
r08_mean=squeeze(mean(um));

%%%sofala
r09=xpost(67,:,247:360).*xpost(58,:,247:360).*(xpost(78,:,247:360)+(1-xpost(78,:,247:360)).*xpost(56,:,247:360));
um=shiftdim(r09,1);
r09_mean=squeeze(mean(um));

%%%tete
r010=xpost(68,:,247:360).*xpost(58,:,247:360).*(xpost(79,:,247:360)+(1-xpost(79,:,247:360)).*xpost(56,:,247:360));
um=shiftdim(r010,1);
r010_mean=squeeze(mean(um));

%%%zambezia
r011=xpost(69,:,247:360).*xpost(58,:,247:360).*(xpost(80,:,247:360)+(1-xpost(80,:,247:360)).*xpost(56,:,247:360));
um=shiftdim(r011,1);
...
figure(31)
        ...
        hold on
        plot(tm,xpost_mean(247:360,59),'r','Linewidth',2)% location 1 
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,70),'r','Linewidth',2)% location 1 
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,60),'r','Linewidth',2)% location 1 
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,71),'r','Linewidth',2)% location 1 
        ylabel('\alpha prior ', 'FontSize', 11)
        title('\alpha_2')
        set (gca,'FontSize',12)
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,61),'r','Linewidth',2)% location 1 
        ylabel('\beta prior', 'FontSize', 11)
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,72),'r','Linewidth',2)% location 1 
        ylabel('\alpha prior ', 'FontSize', 11)
        title('\alpha_3')
        set (gca,'FontSize',12)
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,62),'r','Linewidth',2)% location 1 
        ylabel('\beta prior', 'FontSize', 11)
        title('\beta_4 Manica')
        legend('95% CrI ','posterior mean','Location','Best')
        legend boxoff 
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,73),'r','Linewidth',2)% location 1 
        ylabel('\alpha prior ', 'FontSize', 11)
        title('\alpha_4')
        set (gca,'FontSize',12)
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,63),'r','Linewidth',2)% location 1 
        ylabel('\beta prior', 'FontSize', 11)
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,74),'r','Linewidth',2)% location 1 
        ylabel('\alpha prior ', 'FontSize', 11)
        title('\alpha_5')
        set (gca,'FontSize',12)
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,64),'r','Linewidth',2)% location 1 
        ylabel('\beta prior', 'FontSize', 11)
        title('\beta_6 Maputo')
        legend('95% CrI ','posterior mean','Location','Best')
        legend boxoff 
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,75),'r','Linewidth',2)% location 1 
        ylabel('\alpha prior ', 'FontSize', 11)
        title('\alpha_6')
        set (gca,'FontSize',12)
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,65),'r','Linewidth',2)% location 1 
        ylabel('\beta prior', 'FontSize', 11)
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,76),'r','Linewidth',2)% location 1 
        ylabel('\alpha prior ', 'FontSize', 11)
        title('\alpha_7')
        set (gca,'FontSize',12)
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,66),'r','Linewidth',2)% location 1 
        ylabel('\beta prior', 'FontSize', 11)
        title('\beta_8 Niassa')
        legend('95% CrI ','posterior mean','Location','Best')
        legend boxoff 
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,77),'r','Linewidth',2)% location 1 
        ylabel('\alpha prior ', 'FontSize', 11)
        title('\alpha_8')
        set (gca,'FontSize',12)
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,67),'r','Linewidth',2)% location 1 
        ylabel('\beta prior', 'FontSize', 11)
        title('\beta_9 Sofala')
        legend('95% CrI ','posterior mean','Location','Best')
        legend boxoff 
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,78),'r','Linewidth',2)% location 1 
        ylabel('\alpha prior ', 'FontSize', 11)
        title('\alpha_9')
        set (gca,'FontSize',12)
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,68),'r','Linewidth',2)% location 1 
        ylabel('\beta prior', 'FontSize', 11)
        title('\beta_{10} Tete')
        legend('95% CrI ','posterior mean','Location','Best')
        legend boxoff 
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,79),'r','Linewidth',2)% location 1 
        ylabel('\alpha prior ', 'FontSize', 11)
        title('\alpha_{10}')
        set (gca,'FontSize',12)
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,69),'r','Linewidth',2)% location 1 
        ylabel('\beta prior', 'FontSize', 11)
        ...
        fill(x2, inBetween, 'g','FaceAlpha',0.3,'EdgeColor', 'none');
        hold on
        plot(tm,xpost_mean(247:360,80),'r','Linewidth',2)% location 1 
        ylabel('\alpha prior ', 'FontSize', 11)
        title('\alpha_{11}')
        set (gca,'FontSize',12)
...
figure (91)
 ...
 x2 = [xx, fliplr(xx)];
    ...
    hold on
    plot(tm,xpost_mean(247:360,5),'r-','Linewidth', 1.5)
    hold on
    plot(tm, data(1,:), 'b.')
 ...
 fill(x2, inBetween, 'r','FaceAlpha',0.3,'EdgeColor', 'none');
 hold on
 plot(tm,xpost_mean(247:360,10),'r-','Linewidth', 1.5)
 hold on
 plot(tm, data(2,:), 'b.')
 xlabel('Date', 'FontSize', 12.5)
 ylabel('Daily new cases (population)', 'FontSize', 12.5)
 ...
 fill(x2, inBetween, 'r','FaceAlpha',0.3,'EdgeColor', 'none');
 hold on
 plot(tm,xpost_mean(247:360,15),'r-','Linewidth', 1.5)
 hold on
 plot(tm, data(3,:), 'b.')
 xlabel('Date', 'FontSize', 12.5)
 ylabel('Daily new cases (population)', 'FontSize', 12.5)
 ...
 fill(x2, inBetween, 'r','FaceAlpha',0.3,'EdgeColor', 'none');
 hold on
 plot(tm,xpost_mean(247:360,20),'r-','Linewidth', 1.5)
 hold on
 plot(tm, data(4,:), 'b.')
 xlabel('Date', 'FontSize', 12.5)
 ylabel('Daily new cases (population)', 'FontSize', 12.5)
...
figure (95)
 ...
 fill(x2, inBetween, 'r','FaceAlpha',0.3,'EdgeColor', 'none');
 hold on
 plot(tm,xpost_mean(247:360,25),'r-','Linewidth', 1.5)
 hold on
 plot(tm, data(5,:), 'b.')
 xlabel('Date', 'FontSize', 12.5)
 ylabel('Daily new cases (population)', 'FontSize', 12.5)
...
figure (96)
 ...
 fill(x2, inBetween, 'r','FaceAlpha',0.3,'EdgeColor', 'none');
 hold on
 plot(tm,xpost_mean(247:360,30),'r-','Linewidth', 1.5)
 hold on
 plot(tm, data(6,:), 'b.')
 xlabel('Date', 'FontSize', 12.5)
 ylabel('Daily new cases (population)', 'FontSize', 12.5)
 ...
 fill(x2, inBetween, 'r','FaceAlpha',0.3,'EdgeColor', 'none');
 hold on
 plot(tm,xpost_mean(247:360,35),'r-','Linewidth', 1.5)
 hold on
 plot(tm, data(7,:), 'b.')
 xlabel('Date', 'FontSize', 12.5)
 ylabel('Daily new cases (population)', 'FontSize', 12.5)
 ...
 fill(x2, inBetween, 'r','FaceAlpha',0.3,'EdgeColor', 'none');
 hold on
 plot(tm,xpost_mean(247:360,40),'r-','Linewidth', 1.5)
 hold on
 plot(tm, data(8,:), 'b.')
 xlabel('Date', 'FontSize', 12.5)
 ylabel('Daily new cases (population)', 'FontSize', 12.5)
 ...
 fill(x2, inBetween, 'r','FaceAlpha',0.3,'EdgeColor', 'none');
 hold on
 plot(tm,xpost_mean(247:360,45),'r-','Linewidth', 1.5)
 hold on
 plot(tm, data(9,:), 'b.')
 xlabel('Date', 'FontSize', 12.5)
 ylabel('Daily new cases (population)', 'FontSize', 12.5)
 ...
 fill(x2, inBetween, 'r','FaceAlpha',0.3,'EdgeColor', 'none');
 hold on
 plot(tm,xpost_mean(247:360,50),'r-','Linewidth', 1.5)
 hold on
 plot(tm, data(10,:), 'b.')
 xlabel('Date', 'FontSize', 12.5)
 ylabel('Daily new cases (population)', 'FontSize', 12.5)
 ...
 fill(x2, inBetween, 'r','FaceAlpha',0.3,'EdgeColor', 'none');
 hold on
 plot(tm,xpost_mean(247:360,55),'r-','Linewidth', 1.5)
 hold on
 plot(tm, data(11,:), 'b.')
 xlabel('Date', 'FontSize', 12.5)
 ylabel('Daily new cases (population)', 'FontSize', 12.5)
